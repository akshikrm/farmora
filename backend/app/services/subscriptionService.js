...
const { sequelize, packages, subscriptions } = require('../../models');
const paymentService = require("./paymentService");

exports.createPackage = async (insertData) => {
    try {
...
exports.getAllPackages = async (page = 1, limit = 10, filters = {}) => {
    try {
...
exports.createSubscription = async (userId, packageId) => {
