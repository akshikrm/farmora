...
class AddGeneralExpensePage extends StatefulWidget {
  const AddGeneralExpensePage({super.key});

  @override
  State<AddGeneralExpensePage> createState() => _AddGeneralExpensePageState();
}

class _AddGeneralExpensePageState extends State<AddGeneralExpensePage> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final success = await context.read<GeneralExpensesProvider>().addExpense({
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer<GeneralExpensesProvider>(
