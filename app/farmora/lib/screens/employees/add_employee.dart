...
class AddEmployee extends StatefulWidget {
  ...
  const AddEmployee({Key? key, this.user}) : super(key: key);
...
class _AddEmployeeState extends State<AddEmployee> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<UsersProvider>(builder: (context, provider, child) {
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          isEdit
                              ? 'Update employee information and assign a role'
                              : 'Create a new employee by filling in all required fields and selecting a role',
                          style: TextStyle(
                            color: Colors.blue.shade700,
                            fontSize: 13,
                            height: 1.4,
                        ...
                        Consumer<UsersProvider>(
                          builder: (context, usersProvider, _) {
                            ...
                            if (rolesData['status'] == 'success' &&
                                rolesData['data'] != null) {
                              final data = rolesData['data']['data'];
                              if (data is List) {
                                rolesList =
